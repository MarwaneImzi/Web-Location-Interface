...
if ($_SERVER['REQUEST_METHOD'] === 'GET')
	{
		...
		{
			$describeQuery="select * from students where StudentID LIKE '%".$StudentID."%'";
...
<ul>
				...
				<li><a class="active" href="location.php">Student location</a></li>
            </ul>
			<div class="bg"></div>
			...
			<Form name="24hrsform" action="Location.php" method="get">
